export default {
  logoSrc: "/asset/images/logo_white.png",
  logoHref: "/index.html",
  list: [
      {
          "type": "sysFolder",
      ...
      },
      {
          ...
          sub: [
              ...
              },
              {
                  type: "li",
                  href: "/move.html",
                  iconPathHtml: `<path fill-rule="evenodd" d="M1 11.5a.5.5 0 0 0 .5.5h11.793l-3.147 3.146a.5.5 0 0 0 .708.708l4-4a.5.5 0 0 0 0-.708l-4-4a.5.5 0 0 0-.708.708L13.293 11H1.5a.5.5 0 0 0-.5.5zm14-7a.5.5 0 0 1-.5.5H2.707l3.147 3.146a.5.5 0 1 1-.708.708l-4-4a.5.5 0 0 1 0-.708l4-4a.5.5 0 1 1 .708.708L2.707 4H14.5a.5.5 0 0 1 .5.5z"/>`,
                  name: "調儲",
                  active: false,
                  show: false,
              },
              ...
              // },
              {
                  type: "folder",
                  href: "",
                  iconPathHtml: `<path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>`,
                  id: "liQuery",
                  name: "查詢",
                  active: false,
                  show: false,
              },
              {
                  ...
                  sub: [
                      ...
                      },
                      {
                          type: "li",
                          href: "/stock.html",
                          iconPathHtml: `<path d="M0 2a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1v7.5a2.5 2.5 0 0 1-2.5 2.5h-9A2.5 2.5 0 0 1 1 12.5V5a1 1 0 0 1-1-1V2zm2 3v7.5A1.5 1.5 0 0 0 3.5 14h9a1.5 1.5 0 0 0 1.5-1.5V5H2zm13-3H1v2h14V2zM5 7.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5z" />`,
                          name: "庫存查詢",
                          active: false,
                          show: false,
                      },
